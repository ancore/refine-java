...
/**
 * This interface defines a project representation of the
 * <a href="https://github.com/OpenRefine/OpenRefine/wiki/OpenRefine-API">OpenRefine API</a>.
 */
public interface RefineProject {
  ...
  /**
   * Returns the project location, same as {@link RefineProject#getId()} and
   * {@link RefineProject#getUrl()}.
   *
